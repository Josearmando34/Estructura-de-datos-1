...
# Posiciones (x, y) para el dibujo del grafo
POS = {
    "Yucatán":      (5.5,  7.3),
    "Campeche":     (3.4,  5.8),
...
# ─────────────────────────────────────────────
#  INCISO A — CAMINO HAMILTONIANO (sin repetir estados)
#  Backtracking exhaustivo sobre todos los posibles inicios
# ─────────────────────────────────────────────
def camino_hamiltoniano(grafo):
    ...
    def bt(actual, visitados, camino, costo):
        # Poda: si ya supero el mejor, no sigo
...
#  Campeche actúa como hub entre la Península y el continente
# ─────────────────────────────────────────────
def recorrido_con_repeticion(grafo):
    ...
    """
    # Pre-calcular Dijkstra desde cada estado
    dist_min, prev_min = {}, {}
    for e in ESTADOS:
...
# ─────────────────────────────────────────────
#  FUNCIÓN AUXILIAR: dibuja un panel del grafo
# ─────────────────────────────────────────────
def _dibujar_panel(ax, grafo, titulo, ruta=None, subtitulo=None):
    ...
    # Aristas activas (presentes en la ruta)
    aristas_act = set()
    if ruta:
    ...
    # Conteo de visitas por estado (para detectar repetidos)
    conteos = {}
    if ruta:
        for e in ruta:
    ...
    # Números de orden sobre cada nodo
    if ruta:
...
# ─────────────────────────────────────────────
#  FUNCIÓN AUXILIAR: tabla de relaciones
# ─────────────────────────────────────────────
